...
// YES, I KNOW THAT MY COORDINATE SYSTEM IS A MONSTROSITY
// I STARTED THIS WITHOUT KNOWING ANYTHING ABOUT WHAT TO DO AND NOW I'M TOO SCARED TO CHANGE IT UNTIL A REWRITE.
// PLEASE DON'T KILL ME.
// AND YES, I KNOW, NOTHING HERE IS SAFE AGAINST vec3(0, 0, 0).
// PLEASE JUST DON'T JUDGE ME. MAYBE I'LL FIX IT IN THE REWRITE.
#include "funcs.h"
#include "axes.h"
int width = 1920;
int height = 1080;
